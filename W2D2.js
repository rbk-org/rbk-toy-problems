...
console.log((26*12*365*24*60*60)
...
if (string ==="ottoman")
{
string="I would pet dogs no bigger than an ottoman"
return string
}
if (string ==="small horse")
{
string="I would pet dogs no bigger than an small horse"
return string
}
if (string ==="Terrier")
{
string="I would pet dogs no bigger than an Terrier"
return string
}
if (string ==="I do not like dogs")
{
string="I would not pet dogs"
return string
}
