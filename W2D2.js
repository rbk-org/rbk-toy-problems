...
console.log((13+14+13+15+16+17+19+13+16+15)/2);
//answer:75.5

// 2-using the console calculate your age in seconds.
console.log(60*60*24*365.25*26);
//(sec*min*hours*days*age)
//answer:820497600
...
function dogsIWouldPet(string){
	if(string ==="ottoman"){return "I would pet dogs no bigger than an ottoman";}
		else if(string ==="small horse"){ return "I would pet dogs no bigger than an small horse"; }
			else if(string ==="small horse"){ return "I would pet dogs no bigger than an Terrier";  }
				else if(string ==="Terrier"){ return "I would pet dogs no bigger than an Terrier" }
					else if (string==="I do not like dogs") {return "I would not pet dogs";}
}
