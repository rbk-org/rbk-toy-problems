...
console.log("average="+(13+14+13+15+16+17+19+13+16+15)/10);


// 2-using the console calculate your age in seconds.

var myAge=23;
console.log(myAge*365*24*60*60);
...
function dogsIWouldPet(string){
  ...
  console.log("I would pet dogs no bigger than an " + string);
} else 
{
  console.log("I would not pet dogs");
}
}
...
function convertToKilometers(number){
