...
function average(){
var arr1 = [13,14,13,15,16,17,19,13,16,15]
var sum = 0
...
console.log(identity("hello world")) // result = hello world
console.log(identity(500)) // result = 500
...
//4- Write a function dogsIWouldPet that tak{es an item (string),
function dogsIWouldPet(input){
	if (input === "I don't like dogs"){
