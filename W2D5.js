...
*/
 ...
 How many times is the upper bound repeated? >>>>>>>>>> once 
 What if we wanted to change the upper bound to 6? >>>> once
 How many changes would be required? just raplace -- if (n > 6) 
