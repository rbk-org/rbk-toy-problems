...
function passwordLongEnough(password){
	if(password.length >= 8){
		...
		return "Please enter password long enogh";
	}
}
...
function rentalCar(personName,personAge){
	if(personAge > 21 ){
		return personName+" Have fun driving";
	}	else {
		return personName+' You cannot have the keys';
	} 
} 
