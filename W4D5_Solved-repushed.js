...
function getPeopleBornIn(staff){
	return filter(staff,function(element){
	return element.birthDay.month === "August" 
	})
}
console.log(getPeopleBornIn(staff)) // result = ["Ben Bitdiddle: August 19, 1984", "Lem Tweakit: August 11, 1989"]