...
for(let i = 0; i<timesArr.length;i++){
   return str ="The next 2 busses arrives in"+" "+ timesArr[i]+" and "+timesArr[i+1]+" "+"minutes."
   i++;
   }
}
nextTwoBusTimes([12, 24, 35, 47, 60]); //"The next 2 busses arrive in 12 and 24 minutes."
...
function nextAndLastBusTimes(timesArr) {
   ...
   let i=0;
for(let i = 0; i<timesArr.length;i++){
   return str ="The next 2 busses arrives in"+" "+ timesArr[i]+" and "+timesArr[timesArr.length-1]+" "+"minutes."
   i++;
   }
}
