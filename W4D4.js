...
var obj = {}
 ...
 console.log("myFavoriteSong",myFavoriteSong()); //{title: "Countdown", artist: "Beyonce", durationInSeconds: 212}
...
var bus10Schedule = [12, 24, 35, 47, 60];
 console.log("nextTwoBusTimes",nextTwoBusTimes(bus10Schedule)); 
...
var bus10Schedule = [12, 24, 35, 47, 60];
console.log("nextAndLastBusTimes",nextAndLastBusTimes(bus10Schedule)); 