...
function tallEnoughToRide(a){
	b=[]
for(i=0;i<a.length;i++){
	if(a[i]["heightInInches"]>47){b.push(a[i]["name"])}
}
return b
}
...
function tallestPerson(a){
	b=0
for(i=0;i<a.length;i++){
	if(a[i]["heightInInches"]>b){b=(a[i]["heightInInches"]);c=a[i]["name"] +" at "+b+" inches"}
}
return c
}
