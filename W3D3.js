...
function favoriteDessert (){
	var favoriteDessert = {};
  var favoriteDessertarray = [];

	favoriteDessert.name ="dwali",
	favoriteDessert.countryOfOrigin ="Turcky",
	favoriteDessert.favor ="rice with meat and grabs papers" 
  favoriteDessertarray.push(favoriteDessert)

	return favoriteDessertarray;
}
