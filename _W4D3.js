...
// Your function should add the prices of all the items in the array if the item is true for both lowSugar and lowSodium Finally, your function should return the sum total of all the healthy item
...
function onlyPayForHealthyThings(foodList) {
  ...
  {
    if(foodList[i].nutritionalValue.lowSodium=== true && foodList[i].nutritionalValue.lowSugar === true)
    {
...
onlyPayForHealthyThings(myCart)//return 2.85 from adding the prices of "carrots", "apples", and "avocados"