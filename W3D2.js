...
var input = 'check out how interesting this problem is, it\'s insanelyinteresting!';
var output = flipPairs(input);

function flipPairs(str){
	// spilt str to char then flip pairs and put into new array then join char to str

	var arr = str.spilt(' ');
	var arr1 = [] ;
	for (var i= 0; i< arr.length; i=i+2){
		 return arr1.push(arr[i+1])

	}return arr1.join('');

}
console.log(flipPairs('output'))