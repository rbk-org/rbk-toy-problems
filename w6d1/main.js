...
// I'm a simple html paragraph and the css can controll my attributes. The JS will make the page interactive
              ...
              $('#important').on('click', function() { 
                $('#main-div').css('background', 'red'); 
                $('#text').css('color','white'); 
                $('main-header').css('color','dark red');
            });

                $('#normal').on('click', function() { 
                $('#main-div').css('background', 'lightblue'); 
                $('#text').css('color','white'); 
                $('main-header').css('color','dark blue');
            });
                     $('#rest').on('click', function() { 
                $('#main-div').css('background', 'white'); 
                $('#text').css('color','dark'); 
